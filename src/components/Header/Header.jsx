...
function Header({onCartButton, cartValueSum}) {
  return (
    <header className="header">
        <div className="header__logo">
            <img src={logo} width={40} height={40} alt="logo" className="header__logo-img" />
        ...
        <div className="header__menu">
            <button onClick={onCartButton} className="header__menu-button header__cart">
                ...
                <p className="header__cart-value">{cartValueSum} руб.</p>
            </button>
            <button className="header__menu-button header__user">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
